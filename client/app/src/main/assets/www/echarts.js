...
define('echarts/model/Component', ['require', './Model', 'zrender/core/util', '../util/component', '../util/clazz', '../util/layout', './mixin/boxLayout'], function (require) {
    ...
    clazzUtil.enableClassExtend(ComponentModel, function (option, parentModel, ecModel, extraOpt) {
        ...
        this.uid = componentUtil.getUID('componentModel');    // this.setReadOnly([
...
define('zrender/Handler', ['require', './core/env', './core/event', './core/util', './mixin/Draggable', './core/GestureMgr', './mixin/Eventful'], function (require) {
    ...
    function processGesture(zrHandler, event, stage) {
        ...
        var gestureInfo = gestureMgr.recognize(event, zrHandler.findHover(event.zrX, event.zrY, null), zrHandler.root);
...
define('echarts/component/axis/AxisBuilder', ['require', 'zrender/core/util', '../../util/model', '../../util/graphic', '../../model/Model', '../../data/List', '../../util/number', 'zrender/core/vector'], function (require) {
    var zrUtil = require('zrender/core/util');
    var modelUtil = require('../../util/model');
    var graphic = require('../../util/graphic');
    var Model = require('../../model/Model');
    ...
    var builders = {
            ...
            axisName: function () {
                ...
                var truncateLength = retrieve(opt.axisNameTruncateLength, axisModel.get('nameTruncateLength'));
                var truncateEllipsis = retrieve(opt.axisNameTruncateEllipsis, axisModel.get('nameTruncateEllipsis'));
